/*
 * initialise.c
 * Description: Contains the initialisation functions for all the peripherals like system clock, I2C, SPi etc
 * The registers and clock configurations for each pins are also defined in these methods
 *
